...
*/
$find = "SELECT Timetrack.Empid, Timetrack.Siteid,Timetrack.Sdate,Timetrack.Coordinate,Timetrack.Timeid,Employee.Fname,Employee.Lname,Site.Sitename FROM Timetrack  
